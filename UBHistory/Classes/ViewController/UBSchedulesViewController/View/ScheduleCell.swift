...
class ScheduleCell: UITableViewCell {
    ...
    lazy var leftView: ScheduleCellLeftView = {
        let view = ScheduleCellLeftView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.backgroundColor = .clear
    ...
    var viewModel: HistoryViewModel? {
        didSet {
            self.leftView.viewModel = self.viewModel
    ...
    var settings: UBHistorySettings = .default {
        didSet {
            ...
            self.leftView.settings = self.settings.scheduleLeftViewSettings
    ...
    var deleteAction: (() -> Void)? {
        didSet {
            self.rightView.deleteAction = self.deleteAction
        }
    }
    ...
    private func setup() {
        ...
        self.rightView.hasDelete = true
    }
    
    func setSelection(selected: Bool) {
        let color = selected ? self.settings.mainColor : .white
